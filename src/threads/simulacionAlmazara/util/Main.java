...
public class Main {
    public static void main(String[] args) {
        Datos d = new Datos();
        HiloAceitunero[] aceituneros= new HiloAceitunero[100];
        HiloTransportistaAceite[] transportistasAceite = new HiloTransportistaAceite[100];
        HiloTransportistaOrujo[] transportistasOrujo = new HiloTransportistaOrujo[100];
        for (int i = 0; i < 100; i++) {
