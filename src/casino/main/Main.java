		...
		for (int i = 0; i < 4; i++) {
			...
			switch(juego) {
				case 1:
					...
					//HiloRuleta lanzador=new HiloRuleta(ruleta, partidaNumAl);
					//lanzador.start();
					break;
				case 2:
					...
					//HiloRuleta lanzador1=new HiloRuleta(ruleta, partidaNumPar);
					//lanzador1.start();
					break;
				case 3:
					...
					//HiloRuleta lanzador2=new HiloRuleta(ruleta, partidaMartingala);
					//lanzador2.start();
					break;
			}
		}
